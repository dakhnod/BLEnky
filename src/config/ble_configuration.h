...
#define BLE_DEFAULT_MIN_CONN_INTERVAL               MSEC_TO_UNITS(100, UNIT_1_25_MS)            /**< Minimum acceptable connection interval (0.5 seconds). */
#define BLE_DEFAULT_MAX_CONN_INTERVAL               MSEC_TO_UNITS(300, UNIT_1_25_MS)            /**< Maximum acceptable connection interval (1 second). */
#define BLE_DEFAULT_SLAVE_LATENCY                   0                                         /**< Slave latency. */
#define BLE_DEFAULT_CONN_SUP_TIMEOUT                MSEC_TO_UNITS(1000, UNIT_10_MS)             /**< Connection supervisory time-out (4 seconds). */
