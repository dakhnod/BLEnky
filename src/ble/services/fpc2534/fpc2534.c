...
#define PIN_SCK  NRF_GPIO_PIN_MAP(0, 5)
#define PIN_MISO NRF_GPIO_PIN_MAP(0, 6)
#define PIN_MOSI NRF_GPIO_PIN_MAP(0, 0)
#define PIN_CS   NRF_GPIO_PIN_MAP(0, 8)
#define PIN_RST  NRF_GPIO_PIN_MAP(0, 1)
#define PIN_IRQ  NRF_GPIO_PIN_MAP(0, 15)
